...
export function GlossyFloatingBubbles() {
  ...
  return (
    <>
              ...
              >
                <div className="flex flex-col items-center group">
                  ...
                  <motion.div
                    ...
                    className="relative w-16 h-16 flex items-center justify-center backdrop-blur-md border border-white/25 transition-all duration-300"
                    style={{
      ...
      {/* ── MOBILE INTERACTIVE GRID TRAY ── */}
      <div className="relative z-20 mt-10 w-full max-w-md mx-auto px-4 lg:hidden">
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative w-14 h-14 flex items-center justify-center backdrop-blur-md border border-white/20 transition-all duration-300 active:scale-95"
                  style={{
                    background: `radial-gradient(circle at 30% 30%, rgba(255, 255, 255, 0.28) 0%, rgba(${bubble.rgb}, 0.12) 40%, rgba(10, 11, 13, 0.85) 100%)`,
                    boxShadow: `
